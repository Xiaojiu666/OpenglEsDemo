...
/**
 * Created by GuoXu on 2020/11/27 16:03.
 */
public class LoadedObjectVertexOnly {
    ...
    public LoadedObjectVertexOnly(BaseSurfaceView mv,float[] vertices)
    {
        //初始化顶点坐标与着色数据
    ...
    //初始化shader
    public void initShader(BaseSurfaceView mv)
    {
        //加载顶点着色器的脚本内容
